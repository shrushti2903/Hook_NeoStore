  ...
  switch (action.type) {
    ...
    case FETCH_COMMONPRODUCT_SUCCESS:
      return {
        ...state,
        loading: false,
        commonProduct: action.payload.product_details,
        commonProductTotalCount: action.payload.total_count,
        error: "",
      };
      break;
    ...
    case FETCH_PRODUCTCARTDETAILS_SUCCESS:
      ...
      break;
    case FETCH_PRODUCTDETAILSCLEAR_SUCCESS:
      return {
        ...state,
        loading: false,
        cartData: action.payload,

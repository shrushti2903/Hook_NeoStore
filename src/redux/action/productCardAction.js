    ...
    return axios({
      ...
      .then((response) => {
        const productCardList =
          response && response.data && response.data.products;
...
export const fetchAllProductInHighestRatingSuccess = (
  allProductInHighestRating
) => ({
...
export const fetchAllProductInHighestRating = () => {
  return (dispatch) => {
    ...
    return axios({
      ...
      .then((response) => {
        const allProductInHighestRating =
          response && response.data && response.data.product_details;
        dispatch(
          fetchAllProductInHighestRatingSuccess(allProductInHighestRating)
        );
      })
      .catch((error) => {
...
export const fetchUpdateProductByProductIdSuccess = (
  ...
  return (dispatch) => {
    ...
    return axios({
      ...
      .then((response) => {
        ...
        dispatch(
          fetchUpdateProductByProductIdSuccess(updateProductByProductIdData)
        );
      })
      .catch((error) => {

...
export const fetchColorId = (id) => {
    return dispatch =>{
        ...
        //   console.log('blue color response' , response)
              const colorId = response && response.data && response.data.product_details;
              console.log('response.data blue color', response.data)

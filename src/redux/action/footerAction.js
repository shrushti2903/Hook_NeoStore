...
export const fetchGetFooterData = () => {
  return (dispatch) => {
    ...
    return axios({
      ...
      .then((response) => {
        const getFooterData =
          response && response.data && response.data.company_details;
    ...
    return axios({
      ...
      .then((response) => {
        const getTermsAndConditionsData =
          response && response.data && response.data.termsAndConditions_details;
...
export const fetchGetGaurentee = () => {
  return (dispatch) => {
    ...
    return axios({
      ...
      .then((response) => {
        const getGuarantee =
          response && response.data && response.data.guarantee_details;
